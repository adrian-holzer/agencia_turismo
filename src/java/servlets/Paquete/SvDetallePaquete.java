 ...
 * @author usuario
 */
@WebServlet(name = "SvDetallePaquete", urlPatterns = {"/SvDetallePaquete"})
public class SvDetallePaquete extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Paquete paquete =  cl.buscarPaquete(id);
        ...
        response.sendRedirect("detallePaquete.jsp");
